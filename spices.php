...
<head>
	...
	<meta name="twitter:title" content="Buy Premium Spices Online | Valluvam">
	<meta name="twitter:description" content="Shop premium spices from Valluvam, carefully sourced and freshly packed and delivered to your doorstep across India.">
...
<body class="goto-here">
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<img src="assets/thumbnail/spice.jpg" class="v-cat-badge" alt="Spices" loading="lazy">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Spices</span></p>
					<h1 class="mb-0 bread">Spices</h1>
					<p class="v-cat-desc">Shop premium spices from Valluvam, carefully sourced and freshly packed and delivered to your doorstep across India.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10 mb-5 text-center">
					<ul class="product-category">
						...
						<li><a href="spices.php" class="active">Spices</a></li>
			...
			<p class="v-cat-count" id="spices-count"></p>
			<div class="row v-cat-grid" id="products-spices">
	...
	<script src="assets/js/spices/spices.js"></script>
