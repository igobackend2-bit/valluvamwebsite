$(document).ready(function () {
    $(document).on("keyup", "#search", function () {
        ...
        if (query.length < 2) {
            $("#products-oils").html("<p>Type at least 2 characters to search...</p>");
            return;
        }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status !== "success") {
                    $("#products-oils").html("<p>No products found</p>");
                    return;
                }
            ...
            error: function (xhr) {
                ...
                $("#products-oils").html("<p>Error loading products</p>");
            }
        });
    });
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status === 'success') {
                ...
                $('#products-oils').html('<p>No dryfruits products found.</p>');
            }
        },
        error: function () {
            $('#products-oils').html('<p>Error loading products.</p>');
