$(document).ready(function () {
    $(document).on("keyup", "#search", function () {
        ...
        if (query.length < 2) {
            $("#products-spices").html("<p>Type at least 2 characters to search...</p>");
            return;
        }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status !== "success") {
                    $("#products-spices").html("<p>No products found</p>");
                    return;
                }
            ...
            error: function (xhr) {
                ...
                $("#products-spices").html("<p>Error loading products</p>");
            }
        });
    });
    ...
    function renderProducts(products, containerId) {
        ...
        products.forEach(function (product) {
            ...
            <div class="col-md-6 col-lg-3 mb-3">
              <div class="product">
                <a href="productdetail.php?product=${product.id}-${slugify(product.product_name)}" class="img-prod">
                ...
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3>
                    <a href="productdetail.php?product=${product.id}-${slugify(product.product_name)}">
                  ...
                  <div class="bottom-area d-flex px-3">
                    <div class="m-auto d-flex">
                      <a href="productdetail.php?product=${product.id}-${slugify(product.product_name)}" class="add-to-cart d-flex justify-content-center align-items-center text-center product-detail-btn" data-id="${product.id}">
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status === 'success') {
                    ...
                    html += `
                        <div class="col-md-6 col-lg-3 mb-5">
                            <div class="product">
                                ...
                                <div class="text py-3 pb-4 px-3 text-center">
                                    <h3><a href="productdetail.php?product=${product.id}-${slugify(product.product_name)}">${product.product_name} (${product.quantity})</a></h3>
                                    <div class="d-flex">
                                        <div class="pricing">
                                            <p class="price">`;
                ...
                $('#products-spices').html('<p>No dryfruits products found.</p>');
            }
        },
        error: function () {
            $('#products-spices').html('<p>Error loading products.</p>');
