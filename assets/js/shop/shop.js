...
$(document).ready(function () {
    ...
    $(document).on("keyup", "#search", function () {
        ...
        if (query.length < 2) {
            $("#product-shop").html("<p>Type at least 2 characters to search...</p>");
            return;
        }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status !== "success") {
                    $("#product-shop").html("<p>No products found</p>");
                    return;
                }
            ...
            error: function (xhr) {
                ...
                $("#product-shop").html("<p>Error loading products</p>");
            }
        });
    });
    ...
    function renderProducts(products, containerId) {
        ...
        products.forEach(function (product) {
            // ✅ Guard against null/missing fields so one bad row doesn't break the whole loop
            let name = product.product_name || "Unnamed Product";
            ...
            <div class="col-md-6 col-lg-3 mb-3">
              <div class="product">
                <a href="productdetail.php?product=${product.id}" class="img-prod">
                ...
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3>
                    <a href="productdetail.php?product=${product.id}">
                      ${name} (${quantity})
                    </a>
                  </h3>
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status === 'success') {
                ...
                res.data.forEach(function (product) {
                    ...
                    html += `
                        <div class="col-md-6 col-lg-3 mb-5">
                            <div class="product">
                                ...
                                <div class="text py-3 pb-4 px-3 text-center">
                                    <h3><a href="productdetail.php?product=${product.id}">${name} (${quantity})</a></h3>
                                    <div class="d-flex">
                                        <div class="pricing">
                                            <p class="price">`;
                    ...
                    html += `       </p>
                                    ...
                                    <div class="bottom-area d-flex px-3">
                                        ...
                                        <a href="#" class="buy now d-flex justify-content-center align-items-center btn btn-primary add-to-cart-btn" data-id="${product.id}">
                ...
                $('#product-shop').html('<p class="text-danger">Error loading products.</p>');
            }
        },
        error: function () {
            $('#product-shop').html('<p class="text-danger">Error loading products.</p>');
