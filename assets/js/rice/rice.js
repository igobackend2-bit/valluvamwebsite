$(document).ready(function () {
    $(document).on("keyup", "#search", function () {
        ...
        if (query.length < 2) {
            $("#products-rice").html("<p>Type at least 2 characters to search...</p>");
            return;
        }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status !== "success") {
                    $("#products-rice").html("<p>No products found</p>");
                    return;
                }
            ...
            error: function (xhr) {
                ...
                $("#products-rice").html("<p>Error loading products</p>");
            }
        });
    });
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status === 'success') {
                ...
                $('#products-rice').html('<p>No rice products found.</p>');
            }
        },
        error: function () {
            $('#products-rice').html('<p>Error loading products.</p>');
