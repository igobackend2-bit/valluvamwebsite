<?php $actionpage = basename($_SERVER['PHP_SELF'], ".php");
  ...
  <head>
    ...
    <meta property="og:url" content="https://www.valluvamproducts.com/about">
    <meta property="og:image" content="/images/logo.png">
    <meta property="og:site_name" content="Valluvam">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="About Valluvam — Our Story">
    <meta name="twitter:description" content="Learn about Valluvam, an Indian brand bringing premium nuts, dry fruits, cold-pressed oils, spices and millets to homes and businesses.">
      ...
      <div class="container">
        <div class="heading text-center">
          ...
          <p>Valluvam is a proudly Indian brand built on the foundation of purity, health, and
            ...
            cold-pressed oils, and millets—delivered fresh to your home or business. With a unique
            blend of B2C (retail) and B2B (bulk supply) services, Valluvam caters to both individual
            households and commercial buyers across the country.

          </p>
          <p>We believe in the timeless value of traditional Indian food systems,
            where ingredients were natural, wholesome, and free from chemicals. Our aim is to
            revive and deliver that same purity to today’s modern consumers and businesses through
            a streamlined and transparent process.</p>
        </div>
        <div class="row">
          <div class="col-lg-6">
