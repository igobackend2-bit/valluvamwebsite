$(document).ready(function () {
    $(document).on("keyup", "#search", function () {
        ...
        if (query.length < 2) {
            $("#products-millets").html("<p>Type at least 2 characters to search...</p>");
            return;
        }
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status !== "success") {
                    $("#products-millets").html("<p>No products found</p>");
                    return;
                }
            ...
            error: function (xhr) {
                ...
                $("#products-millets").html("<p>Error loading products</p>");
            }
        });
    });
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status === 'success') {
                    ...
                    html += `
                        <div class="col-md-6 col-lg-3 mb-5">
                            <div class="product">
                                ...
                                <div class="text py-3 pb-4 px-3 text-center">
                                    <h3><a href="productdetail.php?product=${product.id}">${product.product_name} (${product.quantity})</a></h3>
                                    <div class="d-flex">
                                        <div class="pricing">
                                            <p class="price">`;
                ...
                $('#products-millets').html('<p>No dryfruits products found.</p>');
            }
        },
        error: function () {
            $('#products-millets').html('<p>Error loading products.</p>');
