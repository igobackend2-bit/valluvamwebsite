...
<head>
  ...
  <title>Buy Pure Honey Online | Valluvam</title>
  <meta name="description" content="Buy pure, natural honey online from Valluvam, responsibly sourced and delivered fresh to your home.">
  <meta name="keywords" content="buy honey online, pure honey, natural honey, organic honey, Valluvam honey">
  <link rel="canonical" href="https://www.valluvamproducts.com/honey.php">
  <link rel="stylesheet" href="css/category-redesign.css">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="robots" content="index, follow">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Buy Pure Honey Online | Valluvam">
  <meta property="og:description" content="Buy pure, natural honey online from Valluvam, responsibly sourced and delivered fresh to your home.">
  <meta property="og:url" content="https://www.valluvamproducts.com/honey.php">
  <meta property="og:image" content="/images/logo.png">
  <meta property="og:site_name" content="Valluvam">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Buy Pure Honey Online | Valluvam">
  <meta name="twitter:description" content="Buy pure, natural honey online from Valluvam, responsibly sourced and delivered fresh to your home.">
  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Honey", "item": "https://www.valluvamproducts.com/honey.php" }
      ]
    }
  </script>
...
<body class="goto-here">
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Honey</span></p>
          <h1 class="mb-0 bread">Honey</h1>
          <p class="v-cat-desc">Buy pure, natural honey online from Valluvam, responsibly sourced and delivered fresh to your home.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-10 mb-5 text-center">
          <ul class="product-category">
            ...
            <li><a href="honey.php" class="active">Honey</a></li>
      ...
      <div class="v-cat-toolbar">
        <p class="v-cat-count" id="honey-count"></p>
        <!-- Client-side sort over the products already fetched for this page - no new
             ...
             returned by honey_query.php (price / timestamp). There is no "featured" flag
        ...
        <div class="v-cat-sort">
          <label for="honey-sort">Sort by</label>
          <select id="honey-sort">
      ...
      <div class="row v-cat-grid" id="products-honey">
        <!-- All honey products here -->
      </div>
  ...
  <script src="assets/js/honey/honey.js"></script>
