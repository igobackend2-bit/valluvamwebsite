...
<head>
  ...
  <title>Buy Dal Online | Valluvam</title>
  <meta name="description" content="Shop quality dal and lentils online from Valluvam, cleaned, sorted and delivered fresh to your doorstep.">
  <meta name="keywords" content="buy dal online, lentils online, toor dal, moong dal, Valluvam dal">
  <link rel="canonical" href="https://www.valluvamproducts.com/dal.php">
  <link rel="stylesheet" href="css/category-redesign.css">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="robots" content="index, follow">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Buy Dal Online | Valluvam">
  <meta property="og:description" content="Shop quality dal and lentils online from Valluvam, cleaned, sorted and delivered fresh to your doorstep.">
  <meta property="og:url" content="https://www.valluvamproducts.com/dal.php">
  <meta property="og:image" content="/images/logo.png">
  <meta property="og:site_name" content="Valluvam">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Buy Dal Online | Valluvam">
  <meta name="twitter:description" content="Shop quality dal and lentils online from Valluvam, cleaned, sorted and delivered fresh to your doorstep.">
  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Dal", "item": "https://www.valluvamproducts.com/dal.php" }
      ]
    }
  </script>
...
<body class="goto-here">
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Dal</span></p>
          <h1 class="mb-0 bread">Dal</h1>
          <p class="v-cat-desc">Shop quality dal and lentils online from Valluvam, cleaned, sorted and delivered fresh to your doorstep.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-10 mb-5 text-center">
          <ul class="product-category">
            ...
            <li><a href="dal.php" class="active">Dal</a></li>
      ...
      <div class="v-cat-toolbar">
        <p class="v-cat-count" id="dal-count"></p>
        <!-- Client-side sort over the products already fetched for this page - no new
             ...
             returned by dal_query.php (price / timestamp). There is no "featured" flag
        ...
        <div class="v-cat-sort">
          <label for="dal-sort">Sort by</label>
          <select id="dal-sort">
      ...
      <div class="row v-cat-grid" id="products-dal">
        <!-- All dal products here -->
      </div>
  ...
  <script src="assets/js/dal/dal.js"></script>
