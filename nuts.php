...
<head>
    ...
    <title>Buy Premium Nuts Online | Valluvam</title>
    <meta name="description" content="Shop premium nuts from Valluvam, carefully sourced, freshly packed and delivered to your doorstep across India.">
    <meta name="keywords" content="nuts, dry fruits, cold pressed oils, spices online, millets delivery, farm fresh groceries">
    <link rel="canonical" href="https://www.valluvamproducts.com/nuts.php">
    <link rel="stylesheet" href="css/category-redesign.css">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Buy Premium Nuts Online | Valluvam">
    <meta property="og:description" content="Shop premium nuts from Valluvam, carefully sourced, freshly packed and delivered to your doorstep across India.">
    <meta property="og:url" content="https://www.valluvamproducts.com/nuts.php">
    <meta property="og:image" content="/images/logo.png">
    <meta property="og:site_name" content="Valluvam">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Buy Premium Nuts Online | Valluvam">
    <meta name="twitter:description" content="Shop premium nuts from Valluvam, carefully sourced, freshly packed and delivered to your doorstep across India.">
 ...
 <body class="goto-here">
 		...
 		<div class="container">
 			<div class="row no-gutters slider-text align-items-center justify-content-center">
 				<div class="col-md-9 ftco-animate text-center">
 					<img src="assets/thumbnail/nuts.jpg" class="v-cat-badge" alt="Nuts" loading="lazy">
 					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Nuts</span></p>
 					<h1 class="mb-0 bread">Nuts</h1>
 					<p class="v-cat-desc">Shop premium nuts from Valluvam, carefully sourced, freshly packed and delivered to your doorstep across India.</p>
 				</div>
 			</div>
 		</div>
 	</div>
 	...
 	<section class="ftco-section">
 		<div class="container">
 			<div class="row justify-content-center">
 				<div class="col-md-10 mb-5 text-center">
 					<ul class="product-category">
 						...
 						<li><a href="nuts.php" class="active">Nuts</a></li>
 			...
 			<p class="v-cat-count" id="nuts-count"></p>
 			<div class="row v-cat-grid" id="products-nuts">
                  <!--nuts products here-->
 			</div>
	...
	<script src="assets/js/nuts/nuts.js"></script>
