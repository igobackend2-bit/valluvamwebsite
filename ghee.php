...
<head>
  ...
  <title>Buy Pure Ghee Online | Valluvam</title>
  <meta name="description" content="Shop traditionally made pure ghee online from Valluvam, rich in flavour and delivered fresh to your door.">
  <meta name="keywords" content="buy ghee online, pure ghee, cow ghee, desi ghee, Valluvam ghee">
  <link rel="canonical" href="https://www.valluvamproducts.com/ghee.php">
  <link rel="stylesheet" href="css/category-redesign.css">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="robots" content="index, follow">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Buy Pure Ghee Online | Valluvam">
  <meta property="og:description" content="Shop traditionally made pure ghee online from Valluvam, rich in flavour and delivered fresh to your door.">
  <meta property="og:url" content="https://www.valluvamproducts.com/ghee.php">
  <meta property="og:image" content="/images/logo.png">
  <meta property="og:site_name" content="Valluvam">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Buy Pure Ghee Online | Valluvam">
  <meta name="twitter:description" content="Shop traditionally made pure ghee online from Valluvam, rich in flavour and delivered fresh to your door.">
  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Ghee", "item": "https://www.valluvamproducts.com/ghee.php" }
      ]
    }
  </script>
...
<body class="goto-here">
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Ghee</span></p>
          <h1 class="mb-0 bread">Ghee</h1>
          <p class="v-cat-desc">Shop traditionally made pure ghee online from Valluvam, rich in flavour and delivered fresh to your door.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-10 mb-5 text-center">
          <ul class="product-category">
            ...
            <li><a href="ghee.php" class="active">Ghee</a></li>
      ...
      <div class="v-cat-toolbar">
        <p class="v-cat-count" id="ghee-count"></p>
        <!-- Client-side sort over the products already fetched for this page - no new
             ...
             returned by ghee_query.php (price / timestamp). There is no "featured" flag
        ...
        <div class="v-cat-sort">
          <label for="ghee-sort">Sort by</label>
          <select id="ghee-sort">
      ...
      <div class="row v-cat-grid" id="products-ghee">
        <!-- All ghee products here -->
      </div>
  ...
  <script src="assets/js/ghee/ghee.js"></script>
